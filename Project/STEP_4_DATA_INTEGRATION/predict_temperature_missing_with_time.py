...
base_csv = r"formalize_dataset\Temperature\combined_temperature.csv"
...
# Load trained model
model_path = r"formalize_dataset\models\temperature_model.pkl"
model = joblib.load(model_path)

# Reference station data (using 'Malegaon_1' as baseline from sample)
ref_station = base_df[base_df['Station Name'] == 'Malegaon_1']
...
missing_locations = locations_df[locations_df['Temperature'] == 0][['Latitude', 'Longitude']].copy()
all_predicted_data = []
...
updated_csv = os.path.join(output_folder, 'updated_combined_temperature.csv')
