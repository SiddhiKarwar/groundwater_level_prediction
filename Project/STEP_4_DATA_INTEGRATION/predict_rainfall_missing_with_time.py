...
base_csv = r"formalize_dataset\Rainfall\combined_rainfall.csv"
...
# Load trained model
model_path = r"formalize_dataset\models\rainfall_model.pkl"
model = joblib.load(model_path)

# Reference station data (using 'Dhandore (peint)' as baseline from sample)
ref_station = base_df[base_df['Station Name'] == 'Dhandore (peint)']
...
missing_locations = locations_df[locations_df['Rainfall'] == 0][['Latitude', 'Longitude']].copy()
all_predicted_data = []
...
updated_csv = os.path.join(output_folder, 'updated_combined_rainfall.csv')
